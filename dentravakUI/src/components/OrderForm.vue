      ...
      <form ref="form" @submit.prevent="onSubmit">
        ...
        <b-field label="Type">
          <b-select v-model="order.breadType" placeholder="Select a bread type" required expanded>
            <option v-for="option in bread_types" :key="option.id" v-bind:value="option.id">
              {{ option.text }}
            </option>
          </b-select>
        </b-field>
        ...
        <b-field label="Sandwich">
          <b-select v-model="order.sandwich.id" placeholder="Select a sandwich" required expanded>
            <option v-for="option in sandwiches" :key="option.id" v-bind:value="option.id">
